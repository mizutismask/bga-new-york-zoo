...
class NewYorkZooSoloTokens0234Tests extends NewYorkZoo { // this is your game class defined in ggg.game.php
...
$test1 = new NewYorkZooSoloTokens0234Tests();
$test1->testAll();
