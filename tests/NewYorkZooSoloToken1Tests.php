...
class NewYorkZooSoloToken1Tests  extends NewYorkZoo { // this is your game class defined in ggg.game.php
    ...
    function testGetNextActionZones() {
        ...
        $expected = ["action_zone_18", "action_zone_anml_20"];
        $equal = $next === $expected;
...
$test1 = new NewYorkZooSoloToken1Tests();
$test1->testAll();
